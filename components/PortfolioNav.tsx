...
function NavItem(props: { link: string, title: string, active: boolean }) {
    const cls = props.active ? "text-gray-800" : "text-white";
    return (
        <li className="nav-item">
            <a
                className={cls + " px-3 py-2 flex items-center font-bold leading-snug hover:underline hover:decoration-white underline-offset-8 decoration-[2px]"}
                href={props.link}
            >
...
export default function PortfolioNav({ active }: { active?: string }) {
    ...
    return (
        <>
            <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 from-[#cc494c] to-[#cc4998] mb-3 font-serif border-b-4 border-b-white bg-gradient-to-tr">
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                    <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                        <a
                            className="font-bold leading-relaxed inline-block mr-4 whitespace-nowrap text-white"
                            href="/"
                        >
                            Austin Rockwell
                        </a>
