...
function WeekPickerDay({ onClick, day, active }: WeekPickerDayProps) {
    ...
    let weekClass = classNames("relative select-none hover:cursor-pointer w-8 h-8 bg-gray-100 dark:bg-gray-500 dark:text-white rounded-full flex justify-center items-center text-center p-5 shadow-md", {
